...
public class DeathAI extends MonsterAI {
	...
	public Action selectAction(Actor who){
		...
		int playerDistance = Position.flatDistance(aMonster.pos, aPlayer.pos);
		...
		if (playerDistance < 5){
			...
			Position destPosition = Position.add(who.pos,Action.directionToVariation(direction));
