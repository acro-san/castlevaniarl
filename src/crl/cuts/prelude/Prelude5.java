...
public class Prelude5 extends Unleasher {
	public void unleash(Level level, Game game) {
		...
		Display.thus.showScreen(
			...
			"father's body lay fast upon the cold marble floor, in undeniable "+
			"account of the battle just finished. The Count, seeming unwounded "+
			"though his outfit was burnt and torn, reclined in his "+
