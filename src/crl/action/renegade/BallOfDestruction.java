...
public class BallOfDestruction extends Action {
	...
	public void execute() {
		...
		if (i == 20) {
			...
			drawEffect(Main.efx.createDirectedEffect(aPlayer.getPosition(), this.getPositionalDirectionFrom(aPlayer.getPosition()), "SFX_RENEGADE_BOD", 20));
		}
		i = 0;
		for (; i<20; i++) {
			Position destinationPoint = Position.add(aPlayer.getPosition(),
		...
		if (i == 20) {
			...
			drawEffect(Main.efx.createDirectedEffect(aPlayer.getPosition(), this.getPositionalDirectionFrom(aPlayer.getPosition(), otherDir1), "SFX_RENEGADE_BOD", 20));
			//-----
		}
		i = 0;
		for (; i<20; i++) {
		...
		if (i == 20) {
			...
			drawEffect(Main.efx.createDirectedEffect(aPlayer.getPosition(), this.getPositionalDirectionFrom(aPlayer.getPosition(), otherDir2), "SFX_RENEGADE_BOD", 20));
		}
	}
	...
	private boolean hit (Position destinationPoint, int i) {
		...
		if (destinationFeature != null && destinationFeature.isDestroyable()) {
			...
			drawEffect(Main.efx.createDirectedEffect(aPlayer.getPosition(), this.getPositionalDirectionFrom(aPlayer.getPosition()), "SFX_RENEGADE_BOD", i));
