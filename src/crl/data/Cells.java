...
public class Cells {
	public static Cell[] getCellDefinitions(HashMap<String, Appearance> aps) {
		...
		ret[28] = new Cell("TOWN_WATERWAY", "water", "Stream of water", aps.get("TOWN_WATERWAY"));
		ret[28].setShallowWater(true);
		ret[144] = new Cell("TOWN_WATERWAY_UP", "water", "Stream of water", aps.get("TOWN_WATERWAY"));
		ret[144].setWater(true);
		ret[144].setHeightMod(-1);
		ret[145] = new Cell("TOWN_WATERWAY_DOWN", "water", "Stream of water", aps.get("TOWN_WATERWAY"));
		ret[145].setShallowWater(true);
		ret[145].setHeightMod(1);
		ret [146] = new Cell("TOWN_SEWER", "water", "Stream of water", aps.get("TOWN_WATERWAY"));
		ret[146].setWater(true);
		ret [150] = new Cell("TOWN_WATER", "water", "Stream of water", aps.get("TOWN_WATERWAY"));
		...
		ret [57] = new Cell("TOWN_STAIRSUP", "stairs", "Stairs", aps.get("TOWN_STAIRSUP"));
		ret[57].setHeightMod(-1); ret[57].setHeight(1);
		ret [58] = new Cell("TOWN_STAIRSDOWN", "stairs", "Stairs", aps.get("TOWN_STAIRSDOWN"));
		ret[58].setHeightMod(1);/*ret[58].setHeight(1);*/
		ret [118] = new Cell("TOWN_STAIRS", "stairs", "Stairs", aps.get("TOWN_STAIRS"));
		ret[118].setHeight(1);ret[118].setIsStair(true);
		ret [127] = new Cell("TOWN_DOOR", "wooden door", "Wooden Door", aps.get("TOWN_DOOR"), false, true);
		ret [128] = new Cell("TOWN_DOOR_H", "wooden door", "Wooden Door", aps.get("TOWN_DOOR"), false, true);
		ret [128].setHeight(3);
		...
		/*Bridge*/
		ret [62] = new Cell("WOODEN_BRIDGE", "wooden bridge", "Wooden bridgeway", aps.get("WOODEN_BRIDGE"));
		ret [62].setHeight(4);
		ret [63] = new Cell("DARK_LAKE_ETH", "dark lake", "Dark Lake", aps.get("DARK_LAKE"));
		ret[63].setShallowWater(true); 
		ret [147] = new Cell("DARK_LAKE", "dark lake", "Dark Lake", aps.get("DARK_LAKE"));
		ret[147].setWater(true);
		ret [148] = new Cell("LAKE_STAIRSUP", "stairs up", "Stairs Up", aps.get("WOODEN_BRIDGE"));
		ret[148].setWater(true);ret[148].setHeightMod(-1);
		ret [175] = new Cell("DARK_LAKE_ETH_STAIR", "dark lake", "Dark Lake", aps.get("DARK_LAKE"));
		ret[175].setShallowWater(true);ret [175].setHeight(2);
		ret [176] = new Cell("STONE_BLOCK", "stone block", "A massive stone block", aps.get("STONE_BLOCK"), true, true);
		
		
		ret[112] = new Cell("BRIDGE_WALKWAY", "walkway", "Walkway made of old damaged bricks", aps.get("BRIDGE_WALKWAY"));
		ret[112].setHeight(4);
		...
		ret [15] = new Cell("GARDEN_FOUNTAIN_POOL", "fountain wall", "A fountain of water",aps.get("GARDEN_FOUNTAIN_POOL"));
		...
		ret[19] = new Cell("MARBLE_STAIRS", "stairs", "Stairs", aps.get("MARBLE_STAIRS"));
		ret[19].setHeight(1);
		...
		ret[117] = new Cell("MOSS_WATERWAY_ETH", "water", "Stream of putrid water", aps.get("MOSS_WATERWAY_ETH"));
		ret[117].setShallowWater(true);
		ret[117].setHeight(-3);
		ret[141] = new Cell("MOSS_WATERWAY", "water", "Stream of putrid water", aps.get("MOSS_WATERWAY"));
		ret[141].setWater(true);
		
		ret[142] = new Cell("MOSS_STAIRS", "mossy stairs", "Mossy Stairs", aps.get("MOSS_STAIRS"));
		ret[142].setHeight(1);
		ret[142].setIsStair(true);
		ret[143] = new Cell("MOSS_MIDFLOOR", "mossy floor", "Mossy Floor", aps.get("MOSS_MIDFLOOR"));
		ret[143].setHeight(3);
		...
		/* Sewers */
		ret [163] = new Cell("SEWERS_FLOOR", "mossy floor", "Mossy floor", aps.get("SEWERS_FLOOR"));
		ret [163].setShallowWater(true);
		ret [164] = new Cell("SEWERS_WALL", "mossy wall", "Mossy wall", aps.get("SEWERS_WALL"), true, true);
		ret [166] = new Cell("SEWERS_DOWN", "hole down", "Hole going deeper", aps.get("SEWERS_DOWN"));
		ret [166].setShallowWater(true);
		ret [167] = new Cell("SEWERS_UP", "hole up", "Hole on the ceiling", aps.get("SEWERS_UP"));
		ret [167].setShallowWater(true);
		ret [168] = new Cell("SEWERS_FLOOR_WATER", "mossy floor", "Mossy floor", aps.get("SEWERS_FLOOR"));
		ret [168].setWater(true);
		ret [169] = new Cell("SEWERS_WALL_WATER", "mossy wall", "Mossy wall", aps.get("SEWERS_WALL"), true, true);
		
		ret [170] = new Cell("SEWERS_DOWN_WATER", "hole down", "Hole going deeper", aps.get("SEWERS_DOWN"));
		ret [170].setWater(true);
		
		ret [171] = new Cell("SEWERS_UP_WATER", "hole up", "Hole in the ceiling", aps.get("SEWERS_UP"));
		...
		ret [119] = new Cell("CAVE_WATER", "subterranean lake", "Subterranean Lake", aps.get("CAVE_WATER"));
		...
		ret [115] = new Cell("CHURCH_STAIRSUP", "stairs", "Stairs", aps.get("TOWN_STAIRSUP"));
		ret[115].setHeightMod(-1);
		ret [116] = new Cell("CHURCH_STAIRSDOWN", "stairs", "Stairs", aps.get("TOWN_STAIRSDOWN"));
		...
		ret[77] = new Cell("RUINS_FLOOR_H", "stone floor", "Ruined stone floor", aps.get("RUINS_FLOOR_H"));
		ret[77].setHeight(3);
		ret[78] = new Cell("RUINS_STAIRS", "stone stairs", "Ruined stone stairway", aps.get("RUINS_STAIRS"));
		ret[78].setHeight(1);
		...
		ret[122] = new Cell("COURTYARD_FOUNTAIN_POOL", "fountain wall", "A fountain of water",aps.get("COURTYARD_FOUNTAIN_POOL"));
		...
		ret[125] = new Cell("COURTYARD_STAIRS", "ruined brick stairs", "Ruined brick stairs", aps.get("COURTYARD_STAIRS"));
		ret[125].setHeight(1);
		...
		ret[90] = new Cell("TOWER_FLOOR_H", "brick floor (high)", "Gray brick floor", aps.get("TOWER_FLOOR_H"));
		ret[90].setHeight(3);
		ret[91] = new Cell("TOWER_STAIRS", "brick stairs", "Brick stairs", aps.get("TOWER_STAIRS"));
		ret[91].setHeight(1);
		...
		ret[102] = new Cell("TOWER_UP", "stairway up", "Up stairway", aps.get("TOWER_UP"));
		ret[102].setHeightMod(-1);
		ret[103] = new Cell("TOWER_DOWN", "stairway down", "Down stairway", aps.get("TOWER_DOWN"));
